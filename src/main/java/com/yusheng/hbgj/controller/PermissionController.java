...
import com.yusheng.hbgj.service.PermissionService;
...
public class PermissionController {
    ...
    @GetMapping("/current")
    public List<Permission> permissionsCurrent(HttpSession session) {

        List<Permission> list = UserUtil2.getCurrentPermissions();
        if (list == null) {
            ...
            UserUtil2.setPermission(token, list);
        }
...
//	}
    ...
    @PermissionTag(value = {"sys:menu:query", "sys:role:query"}, logical = Logical.OR)
    ...
    public Set<String> ownsPermission(HttpSession session) {
    ...
    @PermissionTag(value = {"sys:menu:del"})
