...
public class ZipUtils {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // FileOutputStream fos1= new FileOutputStream(new File("D:/testZip.zip"));
        //ZipUtils.toZip("C:\\迅雷下载\\axure_chrome_extension_V0.6.3.zip\\axure_chrome_extension_V0.6.3\\", fos1,true);

        /** 测试压缩方法 */
        List<File> fileList = new ArrayList<>();
        fileList.add(new File("D:\\yoga_20200120_202115.sql"));
       // fileList.add(new File("D:/Java/jdk1.7.0_45_64bit/bin/java.exe"));s
